...
//MKT STUDENT
         ...
         $sql = "SELECT
            ...
            ON
            (c.course_id = ct.course_id)
        WHERE ct.course_id IS NULL AND c.mkt_major IS NOT NULL AND c.course_level = '1'";
...
//FIN STUDENT
         ...
         $sql = "SELECT
            ...
            ON
            (c.course_id = ct.course_id)
        WHERE ct.course_id IS NULL AND c.fin_major IS NOT NULL AND c.course_level = '1'";
...
$sql = "SELECT
            ...
            ON
            (c.course_id = ct.course_id)
        WHERE ct.course_id IS NULL AND c.acc_major IS NOT NULL AND c.course_level = '1'";
